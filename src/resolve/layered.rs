...
use super::{
    ConformanceResolver, ExternalResolver, FfiBridgeResolver, LocalTypedCallResolver,
...
impl LayeredResolver {
    ...
    /// 5. [`LocalTypedCallResolver`] — member calls on a local/param whose
    ///    declared/constructed type is known syntactically (additive `Scoped`
    ///    edges, `Provenance::LocalType`).
    /// 6. [`ExternalResolver`] — SCA reachability: import-backed calls into
    ...
    /// 7. [`NormalizedNameResolver`] — case-folded name matching, lowest-tier
